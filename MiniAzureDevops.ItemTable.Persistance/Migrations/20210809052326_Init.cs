    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Items", x => new { x.Id, x.ProjectId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Items_Items_ParentId1_ParentProjectId",
                        columns: x => new { x.ParentId1, x.ParentProjectId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_ParentId1_ParentProjectId",
                table: "Items",
                columns: new[] { "ParentId1", "ParentProjectId" });
